...
The plugin will automatically try to detect the background color of your site, from white, black, green or any color in-between.  We'll shift around the text colors to make sure they are readable.

If you want to change the background color of your forum, you can set a div with a background color on the page your forum is embedded in and we'll use that.
...
= 1.1.3 =
May 8, 2010: Fixes issues some Wordpress installs had from not displaying forum, Uses email address assigned to users in Wordpress for notifications, Displays proper name, And fixes background color detection on some themes, such as kubrik.

= 1.1.2 =
Apr 19, 2010: Fixed minor SSO bug in 1.1.0 release earlier today.
...
= 1.1.4 =
Upgrade to fix issue so "Editor" roles on Wordpress are set to "Moderators" on the forum.  Admins of Wordpress are automatically Admins of the forum.

= 1.1.3 =
Upgrade to fix some issues where the forum wasn't displayed, fix the background color displayed, and correct where email notifications are sent.
